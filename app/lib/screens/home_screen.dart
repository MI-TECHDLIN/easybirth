...
import 'danger_signs_screen.dart';
import 'anc_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildCurrentScreen(
    ...
    switch (_navIndex) {
      case 1:
        return TriageScreen(languageCode: widget.languageCode);
      case 2:
        return const DangerSignsScreen();
      case 3:
        return AncScreen(profile: profile, schedule: schedule);
      default:
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ActionChip(
                      ...
                      side: BorderSide(
                        color: selected
                            ? Colors.transparent
                            : AppColors.outline.withAlpha((0.4 * 255).round()),
                      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: AppColors.background,
      body: SafeArea(child: _buildCurrentScreen(profile, schedule)),
